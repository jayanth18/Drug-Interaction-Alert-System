...
<title>Choose your medicine Medicine</title>
	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			...
			<div class="row">
				<!-- Page Header -->
				<div class="col-lg-12">
					<h1 class="page-header">Choose your medicine</h1>
				</div>
				<!--End Page Header -->
			...
			<div class="row">
				...
				<div class="col-lg-12">
					...
					<div class="panel panel-default" style="min-height: 500px">
						<div class="panel-heading">Select Medicine</div>
							...
							<div class="row">
								...
								<p id="doesnotwork"></p>
									<div class="form-group">
										...
										<select class="form-control" id="medicinename" onchange="getAlert()">
											<%
											while (rs.next()) {
										%>
										<option value="<%=rs.getString("reactionwith")%>"><%=rs.getString("medicinename")%></option>
										<%
											}
										%>
										</select>
