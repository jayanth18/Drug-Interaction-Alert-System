			...
			<div class="row">
				...
				<div class="col-lg-12">
					...
					<div class="panel panel-default" style="min-height: 500px">
						<div class="panel-heading">All Medicine</div>
						<div class="panel-body">
							...
							<div class="row">
								<div class="col-sm-12 hidden-xs "
									...
									<div class="col-sm-6">Medicine name </div>
									<div class="col-sm-4">Reaction with</div>
								</div>
								<%
									...
									while (rs.next()) {
										...
										String reaction = rs.getString("reactionwith");
